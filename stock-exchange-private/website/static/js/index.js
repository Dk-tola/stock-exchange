...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function addToChat(input, finalResult) {
    ...
    userDiv.innerHTML = `<text>${input}</text><img src="https://res.cloudinary.com/ugwutotheeshoes/image/upload/v1625055846/Movie%20booth/download_cwsons.png" alt="Robot cartoon" height="20px" width="20px">`;
    messagesContainer.appendChild(userDiv);
  
    let botDiv = document.createElement("div");
    let botImg = document.createElement("img");
    let botText = document.createElement("text");
    botDiv.id = "bot";
